                ...
                <ul class="navigation-left">
                    <li class="nav-item">
                        <a class="nav-item-hold" href="/">
                            <i class="nav-icon i-Bar-Chart"></i><span class="nav-text">Home</span>
                        </a>
                        {{-- <div class="triangle"></div> --}}
                    </li>
                    <li class="nav-item">
                        <a class="nav-item-hold" href="{{ url('/pos') }}">
                            <i class="nav-icon i-Shopping-Cart"></i><span class="nav-text">POS</span></a>
                        <div class="triangle"></div>
                    </li>
                </ul>
            </div>
